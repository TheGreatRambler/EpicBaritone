...
/**
 * Called when the local player interacts with a block, can be either {@link
 * Type#START_BREAK} or {@link Type#USE}.
 *
 * @author Brady
 * @since 8/22/2018
 */
public final class BlockInteractEvent {
	...
	public enum Type {
		...
		/**
		 * We're right clicking on the target block. Either placing or
		 * interacting with.
		 */
		USE
	}

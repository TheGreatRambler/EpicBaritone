...
public interface IGameEventListener {
	...
	/**
	 * Run once per game tick from before and after the player rotation is sent
	 * to the server.
	 *
	 * @param event The event
	...
	/**
	 * Run once per game tick from before and after the player's moveRelative
	 * method is called and before and after the player jumps.
	 *
	 * @param event The event
	...
	/**
	 * Called whenever the sprint keybind state is checked in {@link
	 * ClientPlayerEntity#livingTick}
	 *
	 * @param event The event
	...
	/**
	 * Called when the local player interacts with a block, whether it is
	 * breaking or opening/placing.
	 *
	 * @param event The event
	 */

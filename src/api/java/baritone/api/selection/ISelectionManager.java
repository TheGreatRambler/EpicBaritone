 ...
 * selection here, as well as retrieving the current selection.
 */
public interface ISelectionManager {
	...
	/**
	 * Adds a new {@link ISelection} constructed from the given block positions.
	 * The new selection is returned.
	 *
	 ...
	 * However, to enforce multi-selection support, this method will only return
	 * a selection if there is ONLY one.
	 *
	...
	/**
	 * This method will always return the last selection. ONLY use this if you
	 * want to, for example, modify the most recent selection based on user
	 * input. ALWAYS use {@link #getOnlySelection()} or, ideally,
	...
	/**
	 * Replaces the specified {@link ISelection} with one expanded in the
	 * specified direction by the specified number of blocks. Returns the new
	 * selection.
	 *
	 ...
	 * specified direction by the specified number of blocks. <p> Note that, for
	 * example, if the direction specified is UP, the bottom of the selection
	 * will be shifted up. If it is DOWN, the top of the selection will be
	 * shifted down.
	 *
	...
	/**
	 * Replaces the specified {@link ISelection} with one shifted in the
	 * specified direction by the specified number of blocks. This moves the
	 * whole selection.
	 *

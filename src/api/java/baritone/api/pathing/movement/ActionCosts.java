...
public interface ActionCosts {
	...
	double WALK_ONE_OVER_SOUL_SAND_COST
		= WALK_ONE_BLOCK_COST
		  * 2; // 0.4 in BlockSoulSand but effectively about half
	...
	/**
	 * To walk off an edge you need to walk 0.5 to the edge then 0.3 to start
	 * falling off
	 */
	 ...
	 */
	double CENTER_AFTER_FALL_COST
		= WALK_ONE_BLOCK_COST - WALK_OFF_BLOCK_COST; // 0.927

	/**
	 * don't make this Double.MAX_VALUE because it's added to other things,
	 * maybe other COST_INFs, and that would make it overflow to negative
	 */
	 ...
	 * Since parabolas are symmetric, the amount of time it takes to ascend up
	 * from 1 to 1.25 will be the same amount of time that it takes to fall back
	 * down from 1.25 to 1. And the same applies to the overall shape, if it
	 * takes X ticks to fall back down 1.25 blocks, it will take X ticks to
	 * reach the peak of your 1.25 block leap. Therefore, the part of your jump
	 * from y=0 to y=1.25 takes distanceToTicks(1.25) ticks, and the sub-part
	 * from y=1 to y=1.25 takes distanceToTicks(0.25) ticks. Therefore, the
	 * other sub-part, from y=0 to y-1, takes
	 * distanceToTicks(1.25)-distanceToTicks(0.25) ticks. That's why

...
public class GoalBlock implements Goal, IGoalRenderPos {
	...
	public String toString() {
		return String.format("GoalBlock{x=%s,y=%s,z=%s}",
	...
	public static double calculate(double xDiff, int yDiff, double zDiff) {
		...
		// if yDiff is 1 that means that pos.getY()-this.y==1 which means that
		// we're 1 block below where we should be therefore going from 0,0,0 to
		// a GoalYLevel of pos.getY()-this.y is accurate

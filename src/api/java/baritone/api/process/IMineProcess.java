 ...
 */
default void
	mine(BlockOptionalMetaLookup filter) {
		mine(0, filter);
	}
 ...
 */
default void
	mine(int quantity, BlockOptionalMeta... boms) {
 ...
 */
default void
	mine(int quantity, Block... blocks) {

...
public interface IWorldData {
	 ...
	 * format of a regular world, intended for use on multiplayer servers where
	 * chunks are not traditionally stored to disk, allowing for long distance
	 * pathing with minimal disk usage.
	 *

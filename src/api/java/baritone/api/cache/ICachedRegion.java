...
public interface ICachedRegion extends IBlockTypeAccess {
	 ...
	 * is cached in this world. Similar to {@link ICachedWorld#isCached(int,
	 * int)}, however, the block coordinates should in on a scale from 0 to 511
	 * (inclusive) because region sizes are 512x512 blocks.
	 *

...
public class Waypoint implements IWaypoint {
	 ...
	 * creationTimestamp as a parameter so that it is reserved after a waypoint
	 * is wrote to the disk.
	 *
	 ...
	 */
	public Waypoint(
		String name, Tag tag, BetterBlockPos location, long creationTimestamp) {
		this.name              = name;
		this.tag               = tag;
	...
	public int hashCode() {
		return name.hashCode() ^ tag.hashCode() ^ location.hashCode()
			^ Long.hashCode(creationTimestamp);
	}
	...
	public boolean equals(Object o) {
		...
		return name.equals(w.getName()) && tag == w.getTag()

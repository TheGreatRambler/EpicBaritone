...
public interface IArgParser<T> {
	...
	/**
	 * A stateless argument parser is just that. It takes a {@link
	...
	interface Stateless<T> extends IArgParser<T> {
		 ...
		 * @throws RuntimeException if you want the parsing to fail. The
		 * exception will be caught and turned into an appropriate error.
		 */
	 ...
	 * {@link ICommandArgument}, but it also takes a second argument that can be
	 * any type, referred to as the state.
	 */

 ...
 * the command's bound {@link IBaritone} instance, {@link IPlayerContext} and an
 * easy way to provide multiple valid command execution names through the
 * default constructor. <p> So basically, you should use it because it provides
 * a small amount of boilerplate, but you're not forced to use it.
 *
 * @see ICommand
 *
 * @author LoganDark

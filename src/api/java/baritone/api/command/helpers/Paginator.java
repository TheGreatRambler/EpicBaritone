...
public class Paginator<E> implements Helper {
	...
	public void display(
		Function<E, ITextComponent> transform, String commandPrefix) {
		...
		if(hasPrevPage) {
			...
			prevPageComponent.setStyle(
				prevPageComponent.getStyle().setFormatting(
	...
	public static <T> void paginate(IArgConsumer consumer, Paginator<T> pagi,
		Runnable pre, Function<T, ITextComponent> transform,
		...
		if(consumer.hasAny()) {
			...
			if(!pagi.validPage(page)) {
				throw new CommandInvalidTypeException(consumer.consumed(),
	...
	public static <T> void paginate(IArgConsumer consumer, List<T> elems,
		Runnable pre, Function<T, ITextComponent> transform,
		String commandPrefix) throws CommandException {
		paginate(
			consumer, new Paginator<>(elems), pre, transform, commandPrefix);
	}

	public static <T> void paginate(IArgConsumer consumer, T[] elems,
		Runnable pre, Function<T, ITextComponent> transform,
		String commandPrefix) throws CommandException {
	...
	public static <T> void paginate(IArgConsumer consumer, Paginator<T> pagi,
		Function<T, ITextComponent> transform, String commandPrefix)
	...
	public static <T> void paginate(IArgConsumer consumer, List<T> elems,
		...
		throws CommandException {
		paginate(
			consumer, new Paginator<>(elems), null, transform, commandPrefix);
	}
	...
	public static <T> void paginate(IArgConsumer consumer, T[] elems,
		...
		throws CommandException {
		paginate(
			consumer, Arrays.asList(elems), null, transform, commandPrefix);
	}
	...
	public static <T> void paginate(IArgConsumer consumer, Paginator<T> pagi,
		Function<T, ITextComponent> transform) throws CommandException {

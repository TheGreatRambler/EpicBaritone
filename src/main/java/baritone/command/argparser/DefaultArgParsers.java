...
public class DefaultArgParsers {
	...
	public enum IntArgumentParser implements IArgParser
	.Stateless<Integer> {
		INSTANCE;
	...
	public enum LongArgumentParser implements IArgParser
	.Stateless<Long> {
		INSTANCE;
	...
	public enum FloatArgumentParser implements IArgParser
	.Stateless<Float> {
		INSTANCE;
	...
	public enum DoubleArgumentParser implements IArgParser
	.Stateless<Double> {
		INSTANCE;
	...
	public static class BooleanArgumentParser
		...
		public static final BooleanArgumentParser INSTANCE
	...
	public static final List<IArgParser<?>> ALL
		= Arrays.asList(IntArgumentParser.INSTANCE, LongArgumentParser.INSTANCE,
			FloatArgumentParser.INSTANCE, DoubleArgumentParser.INSTANCE,

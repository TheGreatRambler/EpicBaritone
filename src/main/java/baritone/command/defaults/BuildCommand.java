...
public class BuildCommand extends Command {
	...
	private static final File schematicsDir
		= new File(mc.gameDir, "schematics");
	...
	public void execute(String label, IArgConsumer args)
		...
		File file = args.getDatatypePost(RelativeFile.INSTANCE, schematicsDir)
						.getAbsoluteFile();
		if(FilenameUtils.getExtension(file.getAbsolutePath()).isEmpty()) {
			file = new File(
				file.getAbsolutePath() + "."
				+ Baritone.settings().schematicFallbackExtension.value);
		}
		...
		boolean success = baritone.getBuilderProcess().build(
			file.getName(), file, buildOrigin);
		if(!success) {
	...
	public List<String> getLongDesc() {
		return Arrays.asList("Build a schematic from a file.", "", "Usage:",

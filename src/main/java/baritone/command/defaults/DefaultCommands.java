...
public final class DefaultCommands {
	...
	public static List<ICommand> createAll(IBaritone baritone) {
		...
		List<ICommand> commands      = new ArrayList<>(Arrays.asList(
            ...
            new CommandAlias(baritone,
                Arrays.asList(
                    "modified", "mod", "baritone", "modifiedsettings"),
                "List modified settings", "set modified"),
            new CommandAlias(baritone, "reset",
                "Reset all settings or just one", "set reset"),
            new GoalCommand(baritone), new GotoCommand(baritone),
            ...
            new CommandAlias(baritone, "sethome", "Sets your home waypoint",
                "waypoints save home"),
            new CommandAlias(baritone, "home", "Set goal to your home waypoint",
                "waypoints goal home"),

 ...
 * reflection, because you AREN'T SUPPOSED TO USE THIS to pause and resume
 * Baritone. Make your own process that returns {@link
 * PathingCommandType#REQUEST_PAUSE REQUEST_PAUSE} as needed.
 */
		...
		pausedCommand = new Command(baritone, "paused") {
			...
			public void execute(String label, IArgConsumer args)
				...
				logDirect(String.format(
					"Baritone is %spaused", paused[0] ? "" : "not "));
			}

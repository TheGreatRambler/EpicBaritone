...
public enum DefaultSchematicFormats implements ISchematicFormat {
	...
	/**
	 * The MCEdit schematic specification. Commonly denoted by the ".schematic"
	 * file extension.
	 */
	MCEDIT("schematic") {
		...
		public IStaticSchematic parse(InputStream input) throws IOException {
			return new MCEditSchematic(
				CompressedStreamTools.readCompressed(input));
		}
	},

	/**
	 * The SpongePowered Schematic Specification. Commonly denoted by the
	 * ".schem" file extension.
	 *
	 * @see <a
	 * href="https://github.com/SpongePowered/Schematic-Specification">Sponge
	...
	public boolean isFileType(File file) {
		return this.extension.equalsIgnoreCase(

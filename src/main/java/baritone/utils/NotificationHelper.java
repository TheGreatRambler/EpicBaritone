...
public class NotificationHelper {
	...
	private static void mac(String text) {
		...
		processBuilder.command("osascript", "-e",
			"display notification \"" + text + "\" with title \"Baritone\"");
		try {
	...
	// library, or send notify-send to shell with a ProcessBuilder.
	// Unfortunately the java-gnome library is licenced under the GPL, see

 ...
 * attempting to venture into the world border, and prevents actual movements
 * from placing blocks in the world border.
 */
public class BetterWorldBorder {
	...
	public boolean canPlaceAt(int x, int z) {
		...
		// because we can't place a block at the very edge against a block
		// outside the border it won't let us right click it

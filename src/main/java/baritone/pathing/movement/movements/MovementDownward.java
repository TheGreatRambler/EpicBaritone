...
public class MovementDownward extends Movement {
	...
	public static double cost(CalculationContext context, int x, int y, int z) {
		...
		if(downBlock == Blocks.LADDER || downBlock == Blocks.VINE) {
			...
			// we're standing on it, while it might be block falling, it'll be
			// air by the time we get here in the movement
			return FALL_N_BLOCKS_COST[1]
				+ MovementHelper.getMiningDurationTicks(
					  context, x, y - 1, z, down, false);
		}
	}

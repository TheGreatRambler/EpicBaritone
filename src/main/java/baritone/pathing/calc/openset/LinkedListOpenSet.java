 ...
 * implementation from MineBot. It has incredibly fast insert performance, at
 * the cost of O(n) removeLowest. It sucks. BinaryHeapOpenSet results in more
 * than 10x more nodes considered in 4 seconds.
 *
 * @author leijurv
 */
